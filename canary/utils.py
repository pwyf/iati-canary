...
def fetch_errors():
    ...
    # https://github.com/codeforIATI/iati-data-dump/blob/b7df39e964d370f73e225ef1084e20ea0570bfaa/run.sh#L31-L34
    meta = 'https://gist.githubusercontent.com/codeforIATIbot/' + \
           'efd190029713c6775c43962444dcb8df/raw/metadata.json'
    last_errored_at = request_with_backoff('get', meta).json()['started_at']
    started_at = datetime.utcnow()
    # This gist is generated by:
    # https://github.com/codeforIATI/iati-data-dump/blob/b7df39e964d370f73e225ef1084e20ea0570bfaa/run.sh#L39-L42
