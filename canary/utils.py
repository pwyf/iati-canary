...
def fetch_errors():
    ...
    # https://github.com/codeforIATI/iati-data-dump/blob/118a0f04f2bc42cbafb5a621d6d571b1459c9a9c/run.sh#L31-L36
    meta = 'https://gist.githubusercontent.com/andylolz/' + \
           '131a1d8e844c6ffc7fba30a659ed6abf/raw/metadata.json'
    last_errored_at = request_with_backoff('get', meta).json()['started_at']
    started_at = datetime.utcnow()
    # This gist is generated by:
    # https://github.com/andylolz/iati-data-dump/blob/8b51bd4f91322630aa3e1c5448d732fc07804c36/run.sh#L37-L39
